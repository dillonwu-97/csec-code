...
a = 2
b = 3
# order of the curve is 310717010502520989590206149059164677804
# factoring the number gives 2^2 * 3^7 * 139 * 165229 * 31850531 * 270778799 * 179317983307
...
# Send this to Bob!
public = double_and_add(G, n) # This is doing point multiplication
print(public)
...
# I need to recover the gen_shared_secret?
