...
class Challenge():
    ...
    def challenge(self, your_input):
        ...
        # gives me the signature of a message
        ...
        # verification
        # multiple of something maybe
        elif your_input['option'] == 'verify':
            # i provide a message and a signature and I need the message and signature to be the "same"
            # However, i cannot sign the admin_token. 
            # So i need to forge a signature for the admin_token
            msg_b = bytes.fromhex(your_input['msg'])
            msg_i = bytes_to_long(msg_b)
