...
// this just reads an integer from the start to the end
...
// modify the container by changing the size
// so maybe do something like make_container, then modify it?
// e.g. resize container to 0 or something
// what happens if container gets resized to 0?
...
// print the data in the src and destination containers
