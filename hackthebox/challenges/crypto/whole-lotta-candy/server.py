...
def main(s):
    ...
    while True:
        try:
            ...
            # this encrypts the flag using a specific encryption mode and gives me the hex value
            if option == "1":
            ...
            # this encrypts a message that you send
            elif option == "2":
            ...
            # this allows you to specify the mode of encryption
            elif option == "3":
