...
# the attack is coppersmith, but i dont understand how recovering the small bits allows us to recover the primes
class RSA():

    def __init__(self, key_length):
        self.e = 0x10001
        phi = 0
        prime_length = key_length // 2 # 2048 // 2 = 1024
...
class Bank:
    ...
    def calculateHint(self):
        # you can get each bit of p? 
        # Or some of the bits of p
...
if __name__ == "__main__":
    ...
    vault = "vault_68" # is this relevant?
    passphrase = KEY
