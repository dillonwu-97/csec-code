...
class CAES:
    ...
    def __init__(self):
        ...
        self.cipher = AES.new(self.key, AES.MODE_ECB) # ecb mode encryption
    ...
    def encrypt(self, message):
        ...
        # for each block
        # encrypt the plaintext, starting from the iv
        # xor the current block with the ciphertext
        for block in blocks:
    ...
    # leaked the encryption for two sequential blocks s.t. they are not the last two blocks
